...
<body>
	...
	<div class="formDiv">
		<br>
		<center>
			<h3 style="color: white">Enter Your Expense Details</h3>
		</center>
		<br>
		<hr>

		<center>
			<form:form action="${pageContext.request.contextPath}/saveExpenseDetails" method="POST" modelAttribute="name">
				<br>
				<div class="card">
					<font size="4"><label>Date:</label> </font> <font size="2">
				...
				<br>
				<div>
					<font size="4"> <label>Category:</label>
					</font> <font size="2"> <form:select name="expenseTransactionName" path="expenseTransactionName" items="${expense_categories}"/>
					</font>
				</div>
				<br>
				<br>
				<div>
					<font size="4"> <label>Amount:</label>
					</font> <font size="2"><input type="text" name="amount"> </font>
				</div>
				<br>
				<br>
				<div>
					<label> <font size="4">Extra Notes:</font> <font size="2">(If
							any)</font>
					</label> <font size="2"> <textarea id="myTextArea" rows="5"
							cols="50" name="extraNotes">Your text here</textarea>
					</font>
				</div>
				<br>
				<br>
