...
<body>
	...
	<div class="topnav" id="myTopnav">
		...
		<form:form name="submitForm" method="POST" action="${pageContext.request.contextPath}/logout">
			<input type="hidden" name="param1" value="param1Value"> <A
	...
	<div class="formDiv">
		<br> <br>
		<center>
			<h3 style="color: white">Add Your New Expense Category</h3>
		</center>
		<br>
		<hr>

		<center>
			<form:form action="${pageContext.request.contextPath}/saveExpenseCategory" method="POST">
				<br>
				<br>
				<div>
					<font size="4"> <label>Category Name:</label>
					</font> <font size="2"><input type="text" name="categoryName"> </font>
				</div>
				<br>
				<br>
				<div>
